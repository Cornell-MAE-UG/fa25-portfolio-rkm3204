...
On an individual contribution level, I spear-headed modeling and post-processing analysis of the blade. Once other team members had determined the optimal blade geometry, I utilized SolidWorks to model the blade, projecting Selig 7075 airfoils onto rotated planes and lofting the sketches. Modeling this required close attention to the sizing constraints provided by course staff, ensuring that the blade would operate safely in the wind tunnel dimensions. A dimensioned depiction of this CAD model can be seen above in grey. After producing the design model, we continued to 3D print and test the blade. I assisted with experimental testing, operated the wind tunnel frequency to the outlined specifications. After experimentation, I formulated a MATLAB script to process the power output gaind from the torque-sweeps. This helped the team visualize the performance of our blade, as we took visualize the power outputs as a function of our experimental inputs. 